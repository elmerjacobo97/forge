...
2. **[2026-07-22] Repository-wide Prettier check has a large existing baseline**
   Do instead: run Prettier on changed files plus `git diff --check`; report global `pnpm format:check` failures without rewriting unrelated files.
