...
import { useUpdateBookmarkMutation } from "../hooks/mutations";
...
export function EditBookmarkDialog({
  ...
  const form = useForm({
    defaultValues: {
      ...
      tagsString: bookmark.tags.join(", "),
    },
    validators: {
      onSubmit: bookmarksSchema,
    },
    onSubmit: async ({ value }) => {
      saveBookmark(value as BookmarksSchema);
    },
  });
  ...
  function saveBookmark(data: BookmarksSchema) {
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Update this bookmark. Changes save to your library.
          </DialogDescription>
        </DialogHeader>

        <form
          id="form-edit-bookmark"
          onSubmit={(e) => {
            e.preventDefault();
            e.stopPropagation();
            form.handleSubmit();
        ...
        <DialogFooter>
          ...
          <Button type="submit" form="form-edit-bookmark">
            Save Changes
          </Button>
        </DialogFooter>
      </DialogContent>
