...
export function parseProjectCreateInput(value: unknown): ProjectCreateInput | { error: string } {
...
export function parseProjectUpdateInput(value: unknown): ProjectUpdateInput | { error: string } {
